...
{
    class GetCouponDiscountTestData : IEnumerable<object[]>
    {
    ...
    public class Carts_GetCouponDiscount_Tests
    {
        [Theory]
        [ClassData(typeof(GetCouponDiscountTestData))]
        public void Theory(Cart cart, double expectedAmount)
        {
            ...
            //cart.GetCouponDiscount().ShouldBe(expectedAmount);
        }
    }
}
