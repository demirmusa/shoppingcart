...
{
    class GetTotalAmountAfterDiscountTestData : IEnumerable<object[]>
    {
    ...
    public class Carts_GetTotalAmountAfterDiscounts_Tests
    {
        [Theory]
        [ClassData(typeof(GetTotalAmountAfterDiscountTestData))]
        public void Theory(Cart cart, double expectedAmount)
        {
            ...
            //cart.GetTotalAmountAfterDiscounts().ShouldBe(expectedAmount);
        }
    }
}
