...
{
    class GetCampaignDiscountTestData : IEnumerable<object[]>
    {
    ...
    public class Carts_GetCampaignDiscount_Tests
    {
        [Theory]
        [ClassData(typeof(GetCampaignDiscountTestData))]
        public void Theory(Cart cart, double expectedAmount)
        {
            ...
            //cart.GetCampaignDiscount().ShouldBe(expectedAmount);
        }
    }
}
